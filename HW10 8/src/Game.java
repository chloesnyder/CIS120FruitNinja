...
public class Game implements Runnable {
    public void run() {
        ...
        final JLabel gravity_label = new JLabel("Gravity is on");
        level_score_panel.add(level_label);
        level_score_panel.add(score_label);
        level_score_panel.add(gravity_label);
        level_score_panel.setLayout(new GridLayout(4, 4));
        ...
        final JButton zeroGravity = new JButton("Zero Gravity Mode");
        zeroGravity.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                court.zeroGravity();
            }
        });
        level_score_panel.add(zeroGravity);
