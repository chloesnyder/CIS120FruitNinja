...
public class Fruit extends GameObj {
	...
	public static final int INIT_X = (int) (Math.random() * 380 - 40);
	public static final int INIT_Y = 0;
	public static final int INIT_VEL_X = (int) (Math.random() * 8);
	public static final int INIT_VEL_Y = (int) (Math.random() * 8);
	...
	public static int i = ((int) (Math.random() * fruits.length));
